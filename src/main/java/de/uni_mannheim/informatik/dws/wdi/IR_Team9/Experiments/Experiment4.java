...
public class Experiment4 extends AbstractExperiment{
    ...
    public Experiment4(String ds1, String ds2, int experimentID, double thresh) throws Exception{
    ...
    void setupBlocker(){
        this.BLOCKER_ID = 4;
        this.blocker = BLOCKERS.getBlocker4();
        super.setupBlocker();
    }
    ...
    static void runAll(double thresh) throws Exception{
        ...
        e1 = new Experiment4("dbpedia", "forbes", 1, thresh);
        e1.runExperiment();

        e1 = new Experiment4("dbpedia", "dw", 1, thresh);
        e1.runExperiment();

        e1 = new Experiment4("dw", "forbes", 1, thresh);
        e1.runExperiment();
    }
