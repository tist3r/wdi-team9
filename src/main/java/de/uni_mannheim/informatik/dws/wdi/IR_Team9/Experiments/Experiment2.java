...
public class Experiment2 extends AbstractExperiment{
    ...
    public Experiment2(String ds1, String ds2, int experimentID, double thresh) throws Exception{
    ...
    void setupBlocker(){
        this.BLOCKER_ID = 2;
        this.blocker = BLOCKERS.getBlocker2();
        super.setupBlocker();
    }
    ...
    static void runAll(double thresh) throws Exception{
        ...
        e1 = new Experiment2("dbpedia", "forbes", 1, thresh);
        e1.runExperiment();

        e1 = new Experiment2("dbpedia", "dw", 1, thresh);
        e1.runExperiment();

        e1 = new Experiment2("dw", "forbes", 1, thresh);
        e1.runExperiment();
    }
