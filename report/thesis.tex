...
When only having the company name as common attribute between the sources you face several challenges.
...
\begin{enumerate}
	...
	\item \textbf{Data Quality:} We had to cope with general data quality issues which are represented for example by typos. Levenstheing similarity (C3) caters to this.
...
"dbpedia_251","Kaggle_85019","0.8393644031634047","Amrutanjan Healthcare","amrutanjan health care limited"
